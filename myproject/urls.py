...
urlpatterns = [
    ...
    path('search/topic/<slug:search_phase>/', views.SearchTopicView.as_view(), name='search_topic'),
    path('search/post/<slug:search_phase>/', views.SearchPostView.as_view(), name='search_post'),
